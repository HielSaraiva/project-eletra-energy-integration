package org.eletra.energy.projecteletraenergyintegration;
...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) {
        try {
            ...
            primaryStage.getIcons().add(new Image(Main.class.getResourceAsStream("assets/imgs/logo_eletra.png")));
